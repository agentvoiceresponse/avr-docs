...
# Fixing “No Audio” Issues on Cloud Servers (AVR + Asterisk + Docker)
...
This page explains how to configure them properly in the context of **avr-infra**.
...
* You are using the latest version of `avr-infra`
...
## Example: Hetzner VPS with avr-infra
